...
EXEC @ERROR = sp_trace_setevent @TRACE, 12, 31, @ON -- Duration
EXEC @ERROR = sp_trace_setevent @TRACE, 10, 31, @ON -- Reads

EXEC @ERROR = sp_trace_setevent @TRACE, 41, 31, @ON -- Reads
EXEC @ERROR = sp_trace_setevent @TRACE, 41, 13, @ON -- Duration
EXEC @ERROR = sp_trace_setevent @TRACE, 41, 16, @ON -- Reads
EXEC @ERROR = sp_trace_setevent @TRACE, 41, 17, @ON -- Writes
EXEC @ERROR = sp_trace_setevent @TRACE, 41, 18, @ON -- CPU

EXEC @ERROR = sp_trace_setevent @TRACE, 33, 1, @ON -- CPU
EXEC @ERROR = sp_trace_setevent @TRACE, 33, 31, @ON -- CPU
